...
public class ListofAllServices extends HttpServlet {
  ...
  protected void service(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
     ...
     try
     {
        ResultSet rs = db.UserDAO.getRef().listofAllServices();
        ...
        while(rs.next())
        {
        	...
        	out.println("<td><a href=UpdService.jsp?id="+rs.getString(1)+"><span class='glyphicon glyphicon-edit'></span></a> | <a href=DeleteService?id="+rs.getString(1)+"><span class='glyphicon glyphicon-trash'></span</a>");
            out.println("</tr>");
        }
        out.println("</tbody>");
        out.println("</table>");
